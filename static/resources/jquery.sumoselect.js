...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            ...
            captionFormat:'{0} Seçili', // format of caption text. you can set your locale.
            captionFormatAllSelected:'{0} hepsi seçili!', // format of caption text when all elements are selected. set null to use captionFormat. It will not work if there are disabled elements in select.
