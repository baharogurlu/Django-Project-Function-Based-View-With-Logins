...
$.DateTimePicker = $.DateTimePicker || {
	...
	defaults:  //Plugin Defaults
	{
		...
		shortDayNames: ["Par", "Pzt", "Sal", "Çar", "Per", "Cum", "Cmt"],
		...
		titleContentTime: "Saati Ayarla",
		titleContentDateTime: "Tarih ve Saat Ayarı",
	
		buttonsToDisplay: ["HeaderCloseButton", "SetButton", "ClearButton"],
		setButtonContent: "Ayarla",
		clearButtonContent: "Temizle",
		...
		_setCurrentDate: function()
		{
			...
			if(oDTP.oData.bDateMode || oDTP.oData.bDateTimeMode)
			{
				...
				else
				{
					...
					//seçilen tarihi gösteren popup yeri
					else
